...
if %errorlevel% == 0 (
    ...
    set "HF_HOME=%~dp0..\omnivoice\hf_cache"
    set "PYTHONPATH=%~dp0..\omnivoice\venv\Lib\site-packages"
    start "OmniVoice" /min "..\omnivoice\python\python.exe" "..\omnivoice\game_server.py" --model k2-fsa/OmniVoice --port 8000
