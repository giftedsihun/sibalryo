Traceback (most recent call last):
  File "omnivoice_gui.pyw", line 986, in <module>
    app = OmniVoiceApp()
  File "omnivoice_gui.pyw", line 323, in __init__
    self._build_ui()
    ~~~~~~~~~~~~~~^^
  File "omnivoice_gui.pyw", line 363, in _build_ui
    self._build_demo_tab()
    ~~~~~~~~~~~~~~~~~~~~^^
  File "omnivoice_gui.pyw", line 481, in _build_demo_tab
    self.demo_start_btn = RoundedButton(
        ...
        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "omnivoice_gui.pyw", line 87, in __init__
    self._draw(bg_color)
    ~~~~~~~~~~^^^^^^^^^^
  File "omnivoice_gui.pyw", line 103, in _draw
    self._rounded_rect(2, 3, w - 1, h, r, "#00000044")
    ~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "omnivoice_gui.pyw", line 112, in _rounded_rect
    self.create_arc(x1, y1, x1 + 2*r, y1 + 2*r, start=90, extent=90,
    ~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
                    fill=color, outline=color)
                    ^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "tkinter\__init__.py", line 3002, in create_arc
  File "tkinter\__init__.py", line 2996, in _create
_tkinter.TclError: invalid color name "#00000044"# OmniVoice 🌍
